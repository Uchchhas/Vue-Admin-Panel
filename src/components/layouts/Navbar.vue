                ...
                <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item">
                                <div class="row">
                                    <div class="col-9">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="my-0">Media heading</p>
                                                <span class="text-muted">
                                                {{ textTruncate('Cras sit amet nibh libero, in gravida nulla', 25) }}
                                            </span>
                                    ...
                                    <div class="col-3 pr-0">
                                        <span class="primary-text-color time-text">09:00 AM</span>
                                    </div>
                                </div>
                            </a>
                            <a class="dropdown-item">
                    ...
                    <div v-else
                        ...
                        <div class="d-flex justify-content-center">
                            <img src="../../assets/images/logo.png" class="no-notification-img"
                                 alt="">
                        </div>
                        <p class="text-center font-size-80 m-0 pt-2 pb-0">It's very much boring to do as usual stuffs,
                            let's hear a
